...
// std::cout << "Torso orient = " << desired.torsoOrient;
        ...
        // qDot =  getJointVelocitiesStacked_worldframe(desired.getRelComPose(walkState.supportFoot), current.getRelComPose(walkState.supportFoot),
        //  desired.getRelSwingFootPose(walkState.supportFoot), current.getRelSwingFootPose(walkState.supportFoot), desired.comVel, mAngularVelocity);
...
Eigen::MatrixXd Controller::getTorsoAndSwfJacobian_worldframe() { //FIXME this is still expressed in relative frame
    ...
    Jacobian_tot = Jacobian_tot_.block<12,50>(0, 6);
        ...
        std::cout << "Eshta ya3ammy" << std::endl;
